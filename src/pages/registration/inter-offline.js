...
export default function InternationalOffline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "Indonesia International Invention Expo - Offline Competition":
        break;
      case "Indonesia International Invention Expo - Offline Competition + Full Package":
        break;
      default:
        setCategoryPrice("");
        break;
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbzaKDjKBrwqjnmGSM0MFxoVXR6YoLFDqbk0wtvES851dOsfl1biQ2awTPxTj55sPTuW/exec";
              ...
              <div class="user-details">
                ...
                <div class="input-box">
                  ...
                  >
                    ...
                    <option value="Indonesia International Invention Expo - Offline Competition + Full Package">
