...
function IndonesiaOffline() {
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbzZzz2wWnA00eAcOyzODm3TRwN0bAyOk8CQ_mZxjCvA6_OUZjEXVwEg9F2yrGjXVRIs/exec";
        ...
        <div class="container">
          <div class="content">
            ...
            <h4 className="text-xl">
              Hello IIIEX 2026 participants, please pay attention to the following information before filling out the registration form:
            </h4>
            <br />
            <p>
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="INFORMATION_RESOURCES" className="form-label">
                    Information Resources for IIIEX 2026
                  </label>
                  <select
                    type="text"
