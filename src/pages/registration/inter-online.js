...
import phoneCodesData from "../../lib/data/phoneCodes";
...
export default function InternationalOnline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "Indonesia International Invention Expo - Online Competition":
        setCategoryPrice("$105 USD");
        break;
      case "Indonesia International Invention Expo - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)":
        setCategoryPrice("$225 USD");
        break;
      case "Indonesia International Invention Expo - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)":
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbwHKV-iMgUqZCwfzqZguFAynsr_4tdTqoK_BNob27yZpUGSF1C6UQLpUmf1t2sQy--7/exec";
      ...
      <section className="registration-section">
        <div class="container">
          <div class="content">
            ...
            <br />
            <h4>
              HELLO IIIEX 2026 PARTICIPANTS, Please consider the following
              ...
              <div class="user-details">
                ...
                <div class="input-box">
                  ...
                  >
                    ...
                    <option value="Indonesia International Invention Expo - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="Indonesia International Invention Expo - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
              ...
              <div className="user-details">
                ...
                <div class="input-box">
                  <label for="INFORMATION_RESOURCES" class="form-label">
                    IIIEX 2026 Competition Information Resources
                  </label>
                  <select
                    type="text"
                  ...
                  >
                    ...
                    <option value="IIIEX Website">IIIEX Website</option>
                    <option value="IYSA Instagram">IYSA Instagram</option>
                    <option value="IIIEX Instagram">IIIEX Instagram</option>
